...
科学界有一个庄严的习惯，就是将论文出版期间去世的合作作者的姓名用特殊的符号上标加以标注，而不只是像一般情况一样指出作者的单位。事实上，在一篇论文中有5个作者的姓名上都有这样的标记的情况是十分罕见的。本周的《科学》杂志上就发表了这样一篇论文。该论文展示了现在基因测序能以惊人的速度进行。于此同时，埃博拉病毒夺走了5名作者的生命，这证明了该论文主题的致命性。
